...
//
//	mockgen -typed -package quic -self_package github.com/pagpeter/quic-go -self_package github.com/pagpeter/quic-go -destination mock_packetconn_test.go net PacketConn
//
